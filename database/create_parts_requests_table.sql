...
-- Create a unique index on invoice_number in jobs table to support foreign key
CREATE UNIQUE INDEX IF NOT EXISTS idx_jobs_invoice_number_unique ON jobs(invoice_number) WHERE invoice_number IS NOT NULL;
