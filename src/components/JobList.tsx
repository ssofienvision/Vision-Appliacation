      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="space-y-4 md:space-y-0">
            ...
            <div className="hidden md:grid md:grid-cols-7 gap-4 pb-3 border-b border-gray-200 text-sm font-medium text-gray-700">
            ...
            {filteredJobs.slice(0, 50).map((job) => (
              <div key={job.invoice_number} className="md:grid md:grid-cols-7 gap-4 py-3 border-b border-gray-100 last:border-b-0">
                {/* Mobile card layout */}
                ...
                <div className="hidden md:block text-gray-900 font-medium">
                  {job.invoice_number || (
                ...
                <div className="hidden md:block font-bold text-green-600">
                  ${(job.total_amount || 0).toLocaleString('en-US', { minimumFractionDigits: 2 })}
                </div>
